    ...
    <div class="wrapper"> 
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="<?= base_url('profile'); ?>"><i class="fa fa-dashboard"></i> Profile</a></li>
                    ...
                    <div class="col-md-3" >
                        ...
                        <div class="box box-primary" id="element_overlap">
                            <div class="box-body box-profile">
                                ...
                                ?>
                                <img class="profile-user-img img-responsive img-circle profileImgUrl" src="<?= $profile_url; ?>" alt="<?= $user['first_name']; ?>">
                                <h3 class="profile-username text-center NameEdt"><?= $user['first_name']; ?></h3>
                                <p class="text-muted text-center">Member since <?= date('M. Y', strtotime($this->session->userdata['user']['date_created'])); ?>  </p>
