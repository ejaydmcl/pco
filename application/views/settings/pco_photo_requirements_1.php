            ...
            <section class="content">
                <div class="box box-primary" style="height: auto;">
                    <div class="box-header with-border">
                        <form class="form-horizontal" id="page_header_form">
                            <div class="input-group margin" style="width: 300px;" id="page_header_element_overlap1">
                                <input type="text" id="page_header" name="page_header" class="form-control" value="<?php echo $page_header; ?>">
                                    <span class="input-group-btn">
                                        <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-fw fa-edit"></i></button>
                                    </span>
                            </div>
                        </form>                             
                    </div>                    
                    <div class="box-body">
                        <section class="content">
                            <div class="col-sm-4">
                                <form class="form-horizontal" id="male_photo_header_form" >
                                    <div class="input-group margin" style="width: 300px;" id="male_page_header_element_overlap1">
                                        <input type="text" id="male_photo_header" name="male_photo_header" class="form-control" value="<?php echo $male_photo_header; ?>">
                                            <span class="input-group-btn">
                                                <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-fw fa-edit"></i></button>
                                            </span>
                                    </div>
                            ...
                            <div class="col-sm-8" >
                                <form class="form-horizontal" id="female_photo_header_form">
                                    <div class="input-group margin" style="width: 300px;" id="female_page_header_element_overlap1">
                                        <input type="text" id="female_photo_header" name="female_photo_header" class="form-control" value="<?php echo $female_photo_header; ?>">
                                        <span class="input-group-btn">
                                            <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-fw fa-edit"></i></button>
                                        </span>
                                    </div>
                        ...
                        <ul id="description_list">
                            ...
                            <li id="<?php echo $value['id']; ?>"> <?php echo $value['value']; ?> <a onclick="remove(<?php echo $value['id']; ?>)" href="javascript:void(0);" class="fa fa-fw fa-remove"></a></li>
                            <?php } ?>
                        </ul>
                        </section>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        ...
                        if (data.status === 1)
                        {
                            ...
                            var li = '<li id='+ data.description_entry_id +'>'+ data.description_entry +' <a onclick="remove('+ data.description_entry_id +')" href="javascript:void(0);" class="fa fa-fw fa-remove"></a> </li>';
